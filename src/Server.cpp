...
//         std::cout << "--------"<< std::endl;
//     }
//     currentUser->setNc(fullCommand);
//     if (currentUser->userAuthentified == false)
//     {
//             std::cout << "----- First connection -----" << std::endl;
//             this->firstConnection(i, fullCommand, currentUser); //first connection?
//             fullCommand = "";
//     }
//     else if (currentUser->userAuthentified == true)
//         {
//             std::cout << "----- Regular connection -----" << std::endl;
//             this->regularConnection(fullCommand, currentUser);
//              fullCommand = "";
//         }
//     else if (currentUser->userAuthentified == NICK_AGAIN)
//     {
//         std::string *cmdParams = getCmdParams(fullCommand, currentUser, &paramNumber);
